...
*/
		...
		public static function get_external() {
			...
			$external = array(
				...
				// Select2
				'select2_js' => $select2_js_local,
				'select2_css' => $select2_css_local,

				// Input mask bundle
				'inputmask_js' => $inputmask_js_local,

				// International Telephone Input
				'intl_tel_input_js' => $intl_tel_input_js_local,
				'intl_tel_input_css' => $intl_tel_input_css_local
			);
