	...
	class WS_Form_Submit extends WS_Form_Core {
		...
		public function db_stamp() {
			...
			$sql = $wpdb->prepare(
				...
				WS_Form_Common::get_user_id(false),
				$this->id
			);
		...
		public function setup_from_post_section($section, $form_submit, $section_id = false, $section_repeatable_index = false, &$section_repeatable = array()) {
