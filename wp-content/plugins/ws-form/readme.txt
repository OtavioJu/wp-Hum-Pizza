...
Tags: form, contact form, form builder, forms, custom form, accessible form, responsive form, custom contact form, captcha, recaptcha, hcaptcha, turnstile
...
* [Akismet](https://wsform.com/knowledgebase/spam-check-with-akismet/?ref=84&utm_source=wp_plugins&utm_medium=readme)
* [Amazon S3](https://wsform.com/knowledgebase/amazon-s3/?ref=84&utm_source=wp_plugins&utm_medium=readme)
* [AutomatorWP](https://automatorwp.com/add-ons/ws-form/?ref=84&utm_source=wp_plugins&utm_medium=readme)
...
* [Sendinblue](https://wsform.com/knowledgebase/sendinblue/?utm_source=wp_plugins&utm_medium=readme)
...
.... or use the [Push To Custom Endpoint](https://wsform.com/knowledgebase/push-to-custom-endpoint/?utm_source=wp_plugins&utm_medium=readme) action to integration with your own API.

= PRO Custom Field Plugin Compatibility =

* [Advanced Custom Fields (ACF)](https://wsform.com/knowledgebase/how-to-build-a-wordpress-form-with-the-advanced-custom-fields-acf-plugin/?utm_source=wp_plugins&utm_medium=readme)
...
This endpoint is called when a knowledge base search is performed in the support side to return knowledge article results.
[Terms of Use](https://wsform.com/terms-of-use/) / [Privacy Policy](https://wsform.com/privacy-policy/)
...
Some changes only applicable to [WS Form PRO](https://wsform.com/?utm_source=wp_plugins&utm_medium=readme)
...
= 1.9.7 - 10/20/2022 =
* Added: Compliance with the unfiltered_html capability which prevents saving of unfiltered HTML on all object data [Learn more](https://wsform.com/knowledgebase/preventing-users-from-saving-markup-in-the-layout-editor/)
